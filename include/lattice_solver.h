...
public:
  ~LatticeSolver();
  LatticeSolver(MatrixXd A, VectorXd b, VectorXd c);
  LatticeSolver(MatrixXd A, VectorXd b, VectorXd c, double lb_value, double ub_value);
  LatticeSolver(MatrixXd A, VectorXd b, VectorXd c, VectorXd lb, VectorXd ub);
  LatticeSolver(string problem);
